...
const Register = () => {
  ...
  const HandleValidation = () => {
    ...
    if (FirstName === myVar) {
      ...
      Error("FirstName should be greater 3 characters", "error");
      return false;
    }
    if (LastName === myVar) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (HandleValidation()) {
      setLoading(true);
      try {
       const {data} = await Axios.post(`/USER/AJOUTER`, { form })
          setLoading(false);
    ...
    <div className="home">
      ...
      <div className="container-2">
        <div className="registerMain">
          ...
          <Button sx={{m:'5px' , color:'white'}} variant="outlined" startIcon={<FacebookIcon />}> Facebook</Button>
